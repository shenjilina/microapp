...
// , Input, ConfigProvider, useTheme, tinyThemeVars, themeVars, OpenxuiCssVarsConfig
// eslint-disable-next-line import/no-unresolved
import { Button } from '@stoneui/ui';
...
<template>
  <div>
    ...
    <!-- <div class="btns">
      <Button @click="switchGlobalTheme"> 切换全局主题，当前：{{ currentGlobalTheme }} </Button>
      <Button @click="switchSecondLineTheme"> 切换第二行主题1，当前：{{ currentSecondLineTheme }} </Button>
    </div> -->
    <div>
